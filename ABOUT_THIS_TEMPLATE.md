...
├── sklearn_failure_prediction             # The main python package for the project
...
e.g: `cat sklearn_failure_prediction/VERSION` will get the project version without harming
